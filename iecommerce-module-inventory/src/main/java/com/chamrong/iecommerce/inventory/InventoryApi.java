 ...
 * Provides methods for stock reservation and availability checks.
 */
public interface InventoryApi {
  
  /**
   * Reserves stock for a given product and quantity.
   * Finds the first warehouse with enough available stock.
   */
  ...
  /**
   * Deducts stock (physically removed) and matching reservation.
   * Called when an order is shipped.
   */
  void deductStock(String tenantId, Long productId, int quantity);

  /**
   * Instantly deducts stock for POS without picking/packing reservation.
   * Decrements available quantity directly.
   */
