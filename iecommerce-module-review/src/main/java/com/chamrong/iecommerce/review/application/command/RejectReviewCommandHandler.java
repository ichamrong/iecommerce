...
/** Use case handler for rejecting a review during moderation. */
@Service
@RequiredArgsConstructor
public class RejectReviewCommandHandler {

  private static final Logger log = LoggerFactory.getLogger(RejectReviewCommandHandler.class);
  ...
  /**
   * Reject the review with the given id.
   *
  ...
  public ReviewResponse handle(Long id) {
    ...
    log.info("Rejected review id={} tenantId={}", saved.getId(), saved.getTenantId());
