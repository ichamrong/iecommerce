...
public class BookingEventListener {
  ...
  public void onBookingConfirmed(com.chamrong.iecommerce.booking.BookingConfirmedEvent event) {
    ...
    customerApi.getCustomer(event.customerId()).ifPresent(customer -> {
      ...
      String content = "Your booking for resource " + event.resourceProductId() + " is confirmed.\n" +
          "Time: " + event.startAt() + " to " + event.endAt();
  ...
  public void onBookingReminder(com.chamrong.iecommerce.booking.BookingReminderEvent event) {
    log.info("Handling booking reminder for bookingId={} customerId={}", 
    ...
    customerApi.getCustomer(event.customerId()).ifPresent(customer -> {
      ...
      String content = "Hi " + customer.firstName() + ",\n\n" +
          "This is a friendly reminder that your booking is scheduled for " + event.startAt() + ".\n" +
  ...
  public void onBookingCompleted(com.chamrong.iecommerce.booking.BookingCompletedEvent event) {
    ...
    customerApi.getCustomer(event.customerId()).ifPresent(customer -> {
      ...
      String content = "Please leave a review for your recent booking: " + event.resourceProductId();
