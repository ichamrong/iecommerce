...
public class BookingSlaNotificationListener {
  ...
  public void onSlaWarning(BookingSlaWarningEvent event) {
    ...
    notificationService.sendNotification(
        ...
        "Booking #"
            + event.bookingId()
            + " will auto-cancel in 4 hours if not accepted immediately.");
  }
  ...
  public void onAutoCancelled(BookingAutoCancelledEvent event) {
    ...
    notificationService.sendNotification(
        ...
        "We're sorry, but the host did not confirm your booking (#"
            + event.bookingId()
            + ") within the requested time. You have been fully refunded.");
  }
}
