...
/** Use case: Internal fulfillment step — Pack order. */
@Slf4j
@Component
@RequiredArgsConstructor
public class PackOrderHandler {
  ...
  public OrderResponse handle(Long orderId, String actor) {
    ...
    auditPort.log(
        ...
        prev,
        OrderState.Packing,
        OrderAuditActions.ORDER_PACKING,
        actor,
        null);
    metrics.counter("order.packing", "tenant", tenantId).increment();
